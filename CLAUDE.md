...
- **M6（C 线进化栈）立项**（2026-09-04，docs/superpowers/specs/2026-09-04-m6-evolution-line-design.md）：第三条顶层线路——知识库版本化外置 + hermes -z 反思纯函数 + 窗口冻结合并 + 版本戳入账；spec 增补草案取 §12.6（§12.5 为范式对比线占用）；实施依赖 M4 合并与 M5 节流落地，未插队
